...
CREATE TABLE IF NOT EXISTS booking (
  ...
  roomchoice varchar(50) NOT NULL,
  firstname varchar(50) NOT NULL,
  lastname varchar(50) NOT NULL,
...
INSERT INTO `booking` (`bookingID`, `roomchoice`, `lastname`,`firstname`,`checkin`,`checkout`, `contact`, `extra`, `review`) VALUES 
(1, "Test", "Miller","Liam",'2012-01-01','2012-01-02', 0277786128, "None", "Great!");